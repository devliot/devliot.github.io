...
**Plans:** 2 plans
Plans:
- [ ] 06-01-PLAN.md — Create centralised type definitions + extend demo article data
- [ ] 06-02-PLAN.md — Wire consumer files to centralised types + build/regression verification
...
|-------|----------------|--------|-----------|
| 6. Data Schema Extension | 0/2 | Planned | - |
